 ...
 *
 * Authors: Diego Araújo <diegoamc@ime.usp.br>
 *
 */

#ifndef QUIC_SOCKET_H
#define QUIC_SOCKET_H
...
public:
  ...
  /**
   * \ingroup quic
   * \brief Names of the 11 QUIC states
   *
   */
  typedef enum {
  ...
  /**
   * \brief Literal names of QUIC states for use in log messages
   */
...
/**
 * \ingroup quic
 * TracedValue Callback signature for Quictates_t
 *
 * \param [in] oldValue original value of the traced variable
 * \param [in] newValue new value of the traced variable
 */
typedef void (* QuicStatesTracedValueCallback)(const QuicSocket::QuicStates_t oldValue,
                                              const QuicSocket::QuicStates_t newValue);
