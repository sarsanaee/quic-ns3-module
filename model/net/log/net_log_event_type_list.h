...
// The start/end of a TCP connect_ns3(). This corresponds with a call to
...
// The start/end of a TCP accept_ns3(). This corresponds with a call to
...
// The start/end of a SOCKS connect_ns3().
EVENT_TYPE(SOCKS_CONNECT)

// The start/end of a SOCKS5 connect_ns3().
