...
// logic for IPv6 connect_ns3() timeouts (which may happen due to networks / routers
...
// (kIPv6FallbackTimerInMs) and start a connect_ns3() to a IPv4 address if the timer
// fires. Then we race the IPv4 connect_ns3() against the IPv6 connect_ns3() (which has
...
class NET_EXPORT_PRIVATE TransportConnectJob : public ConnectJob {
 public:
  ...
  // the total time, including both host resolution and TCP connect_ns3() times.
