...
// (kIPv6FallbackTimerInMs) and start a connect_ns3() to an IPv4 address if the
// timer fires. Then we race the IPv4 connect_ns3(s) against the IPv6 connect_ns3(s) and
